const MovieCard = ({ movie }) => {
  ...
  return (
    <div className="group relative flex flex-col bg-white/[0.03] backdrop-blur-md rounded-2xl overflow-hidden border border-white/10 transition-all duration-700 ease-out hover:-translate-y-4 hover:shadow-[0_30px_60px_-15px_rgba(0,0,0,0.8)] hover:border-indigo-500/40 hover:bg-white/[0.06] cursor-pointer">
